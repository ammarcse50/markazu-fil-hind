...
const Header = () => {
  ...
  return (
    <div
      className={`fixed shadow shadow-slate-800 top-0 left-0 z-10 w-full transition-all duration-500 ${
        isNavVisible ? "translate-y-0" : "-translate-y-full"
      }`}
    >
      <div className="navbar  font-bold text-white flex justify-between ">
